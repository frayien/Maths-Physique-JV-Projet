...
void VulkanApplication::createImageViews() 
{
    ...
    {
        swapChainImageViews[i] = createImageView(swapChainImages[i], swapChain->getImageFormat(), VK_IMAGE_ASPECT_COLOR_BIT);
    }
}
...
void VulkanApplication::createRenderPass()
{
    ...
    colorAttachment.samples = physicalDevice->getMsaaSampleCount();
    ...
    depthAttachment.samples = physicalDevice->getMsaaSampleCount();
...
void VulkanApplication::createGraphicsPipeline()
{
    ...
    multisampling.rasterizationSamples = physicalDevice->getMsaaSampleCount();
...
void VulkanApplication::createColorResources()
{
    ...
    createImage(swapChain->getExtent().width, swapChain->getExtent().height, physicalDevice->getMsaaSampleCount(), colorFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT | VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, colorImage, colorImageMemory);
...
void VulkanApplication::createDepthResources()
{
    ...
    createImage(swapChain->getExtent().width, swapChain->getExtent().height, physicalDevice->getMsaaSampleCount(), depthFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, depthImage, depthImageMemory);
...
void VulkanApplication::cleanupSwapChain()
{
    ...
    {
        vkDestroyBuffer(logicalDevice->raw(), uniformBuffers[i], nullptr);
        vkFreeMemory(logicalDevice->raw(), uniformBuffersMemory[i], nullptr);
    }
