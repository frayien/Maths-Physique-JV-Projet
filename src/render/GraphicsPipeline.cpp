    ...
    m_descriptorSetLayout{descriptorSetLayout}
{
    ...
    inputAssembly.topology = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST; // HERE specify topology
    ...
    if (vkCreatePipelineLayout(m_logicalDevice->raw(), &pipelineLayoutInfo, nullptr, &m_pipelineLayout) != VK_SUCCESS)
    {
    ...
    pipelineInfo.renderPass = m_renderPass->raw();
    ...
    vkDestroyShaderModule(m_logicalDevice->raw(), fragShaderModule, nullptr);
...
VkShaderModule GraphicsPipeline::createShaderModule(const std::vector<char>& code)
{
    ...
    if (vkCreateShaderModule(m_logicalDevice->raw(), &createInfo, nullptr, &shaderModule) != VK_SUCCESS)
    {
